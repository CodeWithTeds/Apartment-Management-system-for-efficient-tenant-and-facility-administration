...
<aside x-show="sidebarOpen" class="flex flex-col w-64 bg-gradient-to-b from-blue-900 to-blue-800 shadow-2xl">
    ...
    <nav class="flex-1 px-4 py-6 space-y-2">
        ...
        <!-- Users -->
        <a href="#" class="flex items-center px-4 py-3 rounded-xl transition-all duration-200 group text-blue-100 hover:bg-blue-700 hover:text-white">
            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <a href="{{ route('superadmin.reports.index') }}"
            class="flex items-center px-4 py-3 rounded-xl transition-all duration-200 group
                  {{ request()->routeIs('superadmin.reports.*') ? 'bg-blue-600 text-white shadow-lg' : 'text-blue-100 hover:bg-blue-700 hover:text-white' }}">
            <svg class="w-5 h-5 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
