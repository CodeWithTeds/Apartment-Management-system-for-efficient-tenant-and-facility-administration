                ...
                <form action="{{ route('admin.payments.store') }}" method="POST">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <select id="bill_type" name="bill_type" class="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                                @foreach ($billTypes as $billType)
                                    <option value="{{ $billType }}">{{ ucfirst($billType) }}</option>
                                @endforeach
                            </select>
                        </div>
