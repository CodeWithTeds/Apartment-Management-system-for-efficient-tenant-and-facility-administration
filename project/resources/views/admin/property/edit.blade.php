    ...
    <div class="flex bg-gray-50">
        <div class="flex flex-col flex-1">
            <main class="flex-1 p-6">
                <h1 class="text-3xl font-bold">Admin/Landlord (APARTMENT)</h1>
                <div class="p-8 mt-6 bg-white rounded-lg shadow-lg">
                    <form action="{{ route('admin.property.update', $apartment) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        <div class="mb-6">
                        ...
                        <div class="grid grid-cols-1 gap-8 md:grid-cols-2">
                            <div class="p-6 border-2 border-blue-400 rounded-md">
                                ...
                                <div class="mb-4">
                                    <input type="text" name="monthly_price" value="{{ old('monthly_price', $apartment->monthly_price) }}" class="text-3xl font-bold border-0 focus:ring-0" placeholder="P4500">
                            ...
                            <div class="p-6 border-2 border-green-400 rounded-md">
                                ...
                                <div class="mb-4">
                                    <input type="text" name="short_term_price" value="{{ old('short_term_price', $apartment->short_term_price) }}" class="text-3xl font-bold border-0 focus:ring-0" placeholder="P300">
                                    <span class="text-gray-500">per night</span>
                                    <input type="text" name="short_term_minimum_stay" value="{{ old('short_term_minimum_stay', $apartment->short_term_minimum_stay) }}" class="mt-1 text-sm text-gray-500 border-0 focus:ring-0" placeholder="Minimum stay: 3 nights">
