...
Route::prefix('tenant')->name('tenant.')->middleware(['auth'])->group(function () {
    ...
    Route::middleware('check.tenant.payment')->group(function () {
        ...
        // PDF route no longer needed; view renders a document-style layout
        // Route::get('/agreements/{agreement}/pdf', [\App\Http\Controllers\Tenant\AgreementController::class, 'pdf'])->name('agreements.pdf');
